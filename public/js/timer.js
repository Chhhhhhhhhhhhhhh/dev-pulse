...
async function refreshFocus() {
  ...
  if (data.sessions.length === 0) {
    container.innerHTML = `<div class="empty-state">
      <svg class="empty-state-art" viewBox="0 0 48 48"><circle cx="24" cy="24" r="22" fill="none" stroke="var(--text-tertiary)" stroke-width="1.5" stroke-dasharray="4 2"/><line x1="24" y1="10" x2="24" y2="24" stroke="var(--text-tertiary)" stroke-width="2" stroke-linecap="round"/><line x1="24" y1="24" x2="34" y2="30" stroke="var(--text-tertiary)" stroke-width="2" stroke-linecap="round"/></svg>
      <p>${t("focus.no_sessions")}</p>
    </div>`;
    return;
  }
